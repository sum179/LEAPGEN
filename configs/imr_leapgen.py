...
def get_args_parser(subparsers):
    ...
    subparsers.add_argument('--intertask_coeff', default=0.1, type=float)
    subparsers.add_argument('--same_key_value', default=False, type=bool)
    subparsers.add_argument('--k_mul', default=1.0, type=float)
    # subparsers.add_argument('--dualopt', default=True, type=bool)
    subparsers.add_argument('--dualopt', default=False, type=bool)
    subparsers.add_argument('--same2lr', default=True, type=bool)
    subparsers.add_argument('--cudnn_benchmark', default=True, type=bool)
    # subparsers.add_argument('--same2lr', action='store_false', dest='same lr for 2 opt',
                        # help='')
    # ViT parameters
